...
| ------------------------ | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--boltz_random_seed`    | `null`   | Boltz-specific random seed. In Boltz mode this is passed to the native `--seed` flag and overwrites the global `--random_seed` value when both are set.                                                                            |
